    ...
    public sealed class ExcelNumberFormat : StyleBase
    {
        ...
        internal static string GetFromBuildInFromID(int _numFmtId)
        {
            ...
            if (Thread.CurrentThread.CurrentCulture.Name.Equals("de-DE"))
                return GetGermanBuildInFromID(_numFmtId);
            return GetEnglishBuildInFromID(_numFmtId);
        }

        internal static string GetEnglishBuildInFromID(int _numFmtId)
        {
        ...
        internal static string GetGermanBuildInFromID(int _numFmtId)
        {
        ...
        internal static int GetFromEnglishBuildIdFromFormat(string format)
        {
            switch (format)
            {
                case "General":
